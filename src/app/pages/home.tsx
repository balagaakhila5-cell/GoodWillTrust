...
import testimonialImage1 from "../../assets/girl-image2.png";
      ...
      <section className="py-20 bg-gradient-to-b from-white via-blue-50/20 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              We are dedicated to creating an inclusive society where everyone
              ...
              <div className="relative h-full bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-200 hover:border-primary/30 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg mb-6 group-hover:text-foreground transition-colors duration-300">
                    To empower individuals with disabilities by providing
                    comprehensive support services, skill development programs,
                    and advocacy initiatives that promote independence, dignity,
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-200">
                    <div className="flex items-start gap-3 group/item">
                      <CheckCircle
                        size={18}
                        className="text-primary mt-1 flex-shrink-0 group-hover/item:scale-125 transition-transform"
                      />
            ...
            >
              <div className="relative h-full bg-white rounded-3xl p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border border-secondary/10 hover:border-secondary/30 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg mb-6 group-hover:text-foreground transition-colors duration-300">
                    To build a barrier-free, inclusive society where people with
                    disabilities are valued, respected, and have equal access to
                    education, employment, healthcare, and social participation,
                    enabling them to live with dignity and reach their full
                    potential.
                  </p>
                  ...
                  <div className="space-y-3 pt-4 border-t border-secondary/10">
                    <div className="flex items-start gap-3 group/item">
                      <CheckCircle
                        size={18}
                        className="text-secondary mt-1 flex-shrink-0 group-hover/item:scale-125 transition-transform"
                      />
                      <span className="text-sm text-muted-foreground group-hover/item:text-foreground transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive initiatives designed to empower and support
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  We provide training, guidance, and mentorship to persons with
                  disabilities to help them start and manage their own
                  businesses.
                </p>
                <Link
                  to="/activities"
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  We conduct workshops and training sessions that help
                  individuals learn practical skills that can generate income and
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-primary mb-3">
                  Goodwill Stores Initiative
                </h3>
                <p className="text-muted-foreground mb-4">
                  Creating stores where donated materials are recycled and
                  converted into useful products, serving as employment hubs and
      ...
      <section className="py-20 bg-gradient-to-b from-white to-blue-50/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Hear from the lives we've touched and transformed through our
              programs
            </p>
          </div>
          ...
          <div className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {/* Testimonial 1 */}
              <div className="relative flex flex-col items-center w-full bg-gradient-to-b from-primary/10 to-white rounded-3xl shadow-xl p-8 pt-40">
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 z-10">
                  <div className="w-72 h-72 rounded-full overflow-hidden border-4 border-primary/40 shadow-xl bg-white">
                    <ImageWithFallback
                      src={testimonialImage1}
                      alt="Sai Sudeeksha"
                      className="w-full h-full object-contain object-top scale-[1.18] -translate-y-6"
                    />
                  </div>

                  <div
                    className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-primary text-white rounded-full p-2 shadow-lg"
                    style={{ zIndex: 2 }}
                  >
                    <svg
                      className="w-8 h-8"
                ...
                <div className="mt-24 w-full flex-1 flex flex-col justify-between">
                  <p className="text-muted-foreground text-base leading-relaxed italic mb-6 text-center">
                    ...
                    from society. Every day was painful, and I slowly went into
                    depression. At that difficult time, I contacted Goodwill
                    Trust. Their support, guidance, and motivation completely
                    changed my thinking. They helped me believe in myself again.
                    With their encouragement, I rebuilt my confidence, learned
                    new skills, and started focusing on my career. Today, I am
                    happily working at Amazon, and I feel proud of myself.
                    Goodwill Trust didn't just help me get a job — They helped
                    me find my self-respect and happiness again."
                  </p>
              ...
              {/* Testimonial 2 */}
              <div className="relative flex flex-col items-center w-full bg-gradient-to-b from-secondary/10 to-white rounded-3xl shadow-xl p-8 pt-40">
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 z-10">
                  <div className="w-72 h-72 rounded-full overflow-hidden border-4 border-secondary/40 shadow-xl bg-white">
                    <ImageWithFallback
                      src={testimonialImage2}
                      alt="Hari Krishna"
                      className="w-full h-full object-contain object-top scale-[1.12] -translate-y-4"
                    />
                  </div>

                  <div
                    className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-secondary text-white rounded-full p-2 shadow-lg"
                    style={{ zIndex: 2 }}
                  >
                    <svg
                      className="w-8 h-8"
                ...
                <div className="mt-24 w-full flex-1 flex flex-col justify-between">
                  <p className="text-muted-foreground text-base leading-relaxed italic mb-6 text-center">
                    "Because of Goodwill Trust, I received the right support,
                    guidance, and career direction when I needed it the most.
                    They believed in me when I was unsure about my future. With
                    their help and motivation, I gained confidence, learned
                    skills, and finally got a job at HSBC. This is not just a
                    job… this is a new life, new hope, and new self-respect.
                    Thank you Goodwill Trust for changing my journey. 🙏✨"
                  </p>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-muted-foreground mb-1">
                      Now Working At{" "}
                      <span className="font-semibold text-primary">HSBC</span>
                    </div>
                    <div className="text-xs text-muted-foreground italic">
                      Program Beneficiary
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-white via-blue-50/30 to-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl mb-8 text-muted-foreground leading-relaxed">
            ...
            volunteering, or partnership, every contribution matters.
          </p>
